...
from common.admittance.models import AdmittanceType , Admittance
...
class AdmittanceCreateView(SuccessMessageMixin, CreateView):
    template_name = 'admittance/create.html'
...
class AdmittanceTypeDeleteView(SuccessMessageMixin, DeleteView):
    ...
    def delete(self, request, *args, **kwargs):
        messages.success(self.request, self.success_message)
        return super(AdmittanceTypeDeleteView , self).delete(request, *args, **kwargs)
