...
from app.view.major import patient
...
from common.admittance.models import Admittance
from .form import *
...
class PatientDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        queryset = Patient.objects.prefetch_related(
            Prefetch(
                "ad_patient",
                queryset = Admittance.objects.order_by('-date').filter(patient=self.kwargs["pk"]),
                to_attr="admittances"
            )
