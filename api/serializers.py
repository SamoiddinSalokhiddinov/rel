...
from common.admittance.models import Admittance, AdmittanceType
...
class AdmittanceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Admittance
        fields = ("id",
            "date","start_hour","end_hour","patient","title",
...
class DoctorSerializer(serializers.ModelSerializer):
    ad_doctor = AdmittanceSerializer(many=True)

    class Meta:
        model = Doctor
        fields = ("id" , "name" , "surname", "ad_doctor", )